...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nailedby_Ruu — Premium Nail Artistry in Somolu, Lagos" },
      { name: "description", content: "Premium manicures, pedicures and nail artistry in Somolu, Lagos. A calm, elegant studio for guests who value craft, hygiene and long-lasting results." },
      { name: "theme-color", content: "#f7f4ee" },
      { property: "og:title", content: "Nailedby_Ruu — Premium Nail Artistry in Somolu, Lagos" },
      { property: "og:description", content: "Premium manicures, pedicures and nail artistry in Somolu, Lagos. A calm, elegant studio for guests who value craft, hygiene and long-lasting results." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Nailedby_Ruu" },
      { property: "og:url", content: "https://luxenail-studio.lovable.app/" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Nailedby_Ruu — Premium Nail Artistry in Somolu, Lagos" },
      { name: "twitter:description", content: "Premium manicures, pedicures and nail artistry in Somolu, Lagos. A calm, elegant studio for guests who value craft, hygiene and long-lasting results." },
    ...
    scripts: [
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "NailSalon",
          name: "Nailedby_Ruu",
          description: "Premium manicures, pedicures and nail artistry in Somolu, Lagos.",
          image: [],
          address: {
            "@type": "PostalAddress",
