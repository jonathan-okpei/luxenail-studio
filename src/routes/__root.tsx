...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Luxe Nail Studio — Luxury Nail Salon in Ikeja, Lagos" },
      ...
      { property: "og:title", content: "Luxe Nail Studio — Luxury Nail Salon in Ikeja, Lagos" },
      { property: "og:description", content: "Premium manicures, pedicures and nail artistry in a calm, elegant studio in Ikeja, Lagos." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Luxe Nail Studio" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Luxe Nail Studio — Luxury Nail Salon in Ikeja, Lagos" },
      { name: "twitter:description", content: "Premium manicures, pedicures and nail artistry in Ikeja, Lagos." },
    ],
    links: [
      {
        rel: "stylesheet",
